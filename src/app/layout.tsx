...
export const metadata: Metadata = {
  title: "MarketFlow - Strategic Marketing Agency for Business Growth",
  description: "Accelerate your business growth with data-driven marketing strategies, content marketing, social media campaigns, and analytics from MarketFlow Agency.",
  keywords: "marketing agency, digital marketing, business growth, content marketing, social media marketing, marketing strategy, lead generation",
  metadataBase: new URL("https://marketflow.agency"),
  alternates: {
    canonical: "https://marketflow.agency"
  },
  openGraph: {
    title: "MarketFlow - Strategic Marketing Agency for Business Growth",
    description: "Accelerate your business growth with data-driven marketing strategies, content marketing, social media campaigns, and analytics from MarketFlow Agency.",
    url: "https://marketflow.agency",
    siteName: "MarketFlow",
    images: [{
      url: "https://images.pexels.com/photos/3183153/pexels-photo-3183153.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "MarketFlow marketing team collaborating on strategy"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "MarketFlow - Strategic Marketing Agency for Business Growth",
    description: "Accelerate your business growth with data-driven marketing strategies, content marketing, social media campaigns, and analytics from MarketFlow Agency.",
    images: ["https://images.pexels.com/photos/3183153/pexels-photo-3183153.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
